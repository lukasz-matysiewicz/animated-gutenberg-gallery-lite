...
- Customizable animation duration (0.1s - 4s)
...
Yes, in the Animated G. Gallery Lite version, you can customize the animation duration from 0.1 to 4 seconds in the plugin settings.
